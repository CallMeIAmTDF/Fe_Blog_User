        ...
        <div className="container flex h-16 items-center justify-between max-w-screen-2xl">
          <div className="flex items-center gap-2 md:gap-4">
            <Sheet>
              ...
              <SheetContent side="left">
                <nav className="grid gap-6 text-lg font-medium">
                  <Link href="/blogs" className="flex items-center gap-2 text-lg font-semibold">
                  ...
                  {isAuthenticated && (
                      <Link href={`/users/${user?.id}`} className="hover:text-foreground/80">
                        Hồ Sơ
                      </Link>
                  )}
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm">
              <Link href="/blogs" className="font-medium transition-colors hover:text-foreground/80">
                Khám Phá
              </Link>
              {isAuthenticated && (
                  <Link href="/blogs/new" className="font-medium transition-colors hover:text-foreground/80">
                    Viết Bài
                  </Link>
              )}
              {user?.role === "ROLE_ADMIN" && (
                  <Link href="/admin" className="font-medium transition-colors hover:text-foreground/80">
                    Quản trị
                  </Link>
              )}
            </nav>
